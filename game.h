...
*/
struct game {
	struct board board; /* The board on which the game is played and tiles are placed. */ /**< The board on which the game is played and tiles are placed.*/
	struct tile tile_deck[TILE_COUNT]; /* All tiles to be played in the game. */ /**< All tiles to be played in the game. */
	size_t tiles_used; /* The number of tiles used during the game. */ /**< The number of tiles used during the game. */
	size_t scores[PLAYER_COUNT]; /* Holds the players' scores. */ /**< Holds the players' scores. */
	size_t meeples[PLAYER_COUNT]; /* The number of tigers each player holds. */ /**< The number of tigers each player holds. */
	struct feature *features[AXIS * AXIS * 4 * 3]; /* Mapping of each space on the board to the feature occupying that space. */ /**< Mapping of each space on the board to the feature occupying that space. */
	size_t features_used; /* The number of features in the game */ /**< The number of features in the game. */
};
